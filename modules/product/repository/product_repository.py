...
class ProductRepository:
    ...
    def get_products_filtered(self, query: Optional[str] = None, page: int = 1, limit: int = 12) -> tuple[List[ProductResponse], int]:
        """Obtener productos filtrados por término de búsqueda en varios campos o listar todos con paginación"""
        session = self.db.get_session()
        try:
